...
public class UserDto {
    ...
    private static final String NAME_LENGTH_ERROR = "이름은 2자 이상 10자 미만으로 작성해주세요.";
    private static final String NAME_FORMAT_ERROR = "이름에 숫자 및 특수 문자는 포함될 수 없습니다.";
    private static final String NAME_BLANK_ERROR = "이름을 작성해주세요.";
    private static final String PASSWORD_FORMAT_ERROR = "비밀번호는 8자 이상의 소문자, 대문자, 숫자, 특수문자의 조합이어야 합니다.";
    private static final String PASSWORD_BLANK_ERROR = "패스워드를 작성해주세요.";
    private static final String EMAIL_FORMAT_ERROR = "이메일의 양식이 틀렸습니다.";
    private static final String EMAIL_BLANK_ERROR = "이메일을 작성해주세요.";
